...
export function RepartitionDepensesCanalEuro() {
  ...
  return (
    <Card className="flex flex-col">
      <CardHeader className="items-center pb-0">
        <CardTitle>Répartition par canal en euros</CardTitle>
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none">
          Performance Max : {(1200).toLocaleString()}€ <TrendingUp className="h-4 w-4" />
        </div>
        <div className="leading-none text-muted-foreground">
          Montants des dépenses publicitaires sur les 6 derniers mois
        </div>
      </CardFooter>
    </Card>
  )
